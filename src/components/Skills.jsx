      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="dark-card p-8 rounded-xl shadow-lg card-hover flex flex-col items-center">
            ...
            <p className="text-primary-600 text-center">Experienced in Python, Pandas, NumPy, Matplotlib, Seaborn for data wrangling, visualization, and insight generation.</p>
          </div>
          <div className="dark-card p-8 rounded-xl shadow-lg card-hover flex flex-col items-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-secondary-200 to-secondary-100 rounded-full mb-4 glow-effect">
            ...
            <p className="text-primary-600 text-center">Skilled in LangChain, API Integration, Hugging Face, PyTorch, TensorFlow, AutoGen for building adaptive, intelligent systems.</p>
          </div>
          <div className="dark-card p-8 rounded-xl shadow-lg card-hover flex flex-col items-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-secondary-200 to-secondary-100 rounded-full mb-4 glow-effect">
            ...
            <p className="text-primary-600 text-center">Git, Jupyter—modern tools for robust, scalable development.</p>
          </div>
        </div>
      </div>
    </section>
